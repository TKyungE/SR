#include "..\Public\VIBuffer_WingRect.h"

CVIBuffer_WingRect::CVIBuffer_WingRect(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CVIBuffer(pGraphic_Device)
{
}

CVIBuffer_WingRect::CVIBuffer_WingRect(const CVIBuffer_WingRect & rhs)
	: CVIBuffer(rhs)
{
}

HRESULT CVIBuffer_WingRect::Initialize_Prototype()
{
...
HRESULT CVIBuffer_WingRect::Initialize(void* pArg)
{
	return S_OK;
}

CVIBuffer_WingRect * CVIBuffer_WingRect::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CVIBuffer_WingRect*	pInstance = new CVIBuffer_WingRect(pGraphic_Device);
...
CComponent * CVIBuffer_WingRect::Clone(void* pArg)
{
	CVIBuffer_WingRect*	pInstance = new CVIBuffer_WingRect(*this);

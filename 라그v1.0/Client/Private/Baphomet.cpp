...
CBaphomet::CBaphomet(LPDIRECT3DDEVICE9 _pGraphic_Device)
	: CGameObject(_pGraphic_Device)
{
}

CBaphomet::CBaphomet(const CBaphomet& rhs)
	: CGameObject(rhs)
{
}
HRESULT CBaphomet::Initialize_Prototype(void)
{
...
HRESULT CBaphomet::Initialize(void * pArg)
{
	...
	m_tInfo.iMp = 1;
	m_tInfo.iExp = 30;
	m_tInfo.iMonsterType = (_int)MON_BAPHOMET;
	...
	tInfo.iMonsterType = MON_BAPHOMET;
...
void CBaphomet::Tick(_float fTimeDelta)
{
	...
	if (!m_bRespawn)
	{
		...
		{
			ERR_MSG(TEXT("Failed to Add CollisionGroup : CBaphomet"));
			return;
		}
...
void CBaphomet::Late_Tick(_float fTimeDelta)
{
...
HRESULT CBaphomet::SetUp_Components(void)
{
	...
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_IDLE_Front"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Baphomet_IDLE_Front"), (CComponent**)&m_pTextureComIDLE_Front)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_IDLE_Back"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Baphomet_IDLE_Back"), (CComponent**)&m_pTextureComIDLE_Back)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Move_Front"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Baphomet_Move_Front"), (CComponent**)&m_pTextureComMove_Front)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Move_Back"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Baphomet_Move_Back"), (CComponent**)&m_pTextureComMove_Back)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Attack_Front"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Baphomet_Attack_Front"), (CComponent**)&m_pTextureComAttack_Front)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Attack_Back"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Baphomet_Attack_Back"), (CComponent**)&m_pTextureComAttack_Back)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Dead_Front"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Baphomet_Dead_Front"), (CComponent**)&m_pTextureComDead_Front)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Dead_Back"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Baphomet_Dead_Back"), (CComponent**)&m_pTextureComDead_Back)))
		return E_FAIL;
...
HRESULT CBaphomet::SetUp_RenderState(void)
{
...
HRESULT CBaphomet::Release_RenderState(void)
{
...
void CBaphomet::Chase(_float fTimeDelta)
{
...
void CBaphomet::Chase2(_float fTimeDelta)
{
...
void CBaphomet::Chase3(_float fTimeDelta)
{
	_float Distance = D3DXVec3Length(&(*(_float3*)&m_tInfo.pTarget->Get_World().m[3][0] - m_pTransformCom->Get_State(CTransform::STATE_POSITION)));
	if (1.f >= Distance)
	{
...
CBaphomet * CBaphomet::Create(LPDIRECT3DDEVICE9 _pGraphic_Device)
{
	CBaphomet* pInstance = new CBaphomet(_pGraphic_Device);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		ERR_MSG(TEXT("Failed to Created : CBaphomet"));
		Safe_Release(pInstance);
	}
...
CGameObject * CBaphomet::Clone(void * pArg)
{
	CBaphomet* pInstance = new CBaphomet(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		ERR_MSG(TEXT("Failed to Cloned : CBaphomet"));
		Safe_Release(pInstance);
	}
...
_float4x4 CBaphomet::Get_World(void)
{
	return m_pTransformCom->Get_WorldMatrix();
}

void CBaphomet::Free(void)
{
	__super::Free();
...
HRESULT CBaphomet::On_SamplerState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
HRESULT CBaphomet::Off_SamplerState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
HRESULT CBaphomet::Skill_DefaultAttack(const _tchar * pLayerTag)
{
	CGameInstance*			pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
...
void CBaphomet::Move_Frame(_float fTimeDelta)
{
	switch (m_eCurState)
	{
	case IDLE:
...
void CBaphomet::Use_Skill(_float fTimeDelta)
{
...
HRESULT CBaphomet::TextureRender()
{
	switch (m_eCurState)
	{
	case IDLE:
...
void CBaphomet::MonsterMove(_float fTimeDelta)
{
...
HRESULT CBaphomet::RespawnMonster()
{
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, m_tInfo.vPos);
	m_ePreState = STATE_END;
	m_eCurState = IDLE;

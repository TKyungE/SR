#include "stdafx.h"
#include "..\Public\Bloodymurderer.h"
#include "..\Public\Player.h"
#include "GameInstance.h"
#include "SoundMgr.h"
#include "Layer.h"

CBloodymurderer::CBloodymurderer(LPDIRECT3DDEVICE9 _pGraphic_Device)
	: CGameObject(_pGraphic_Device)
{
}

CBloodymurderer::CBloodymurderer(const CBloodymurderer& rhs)
	: CGameObject(rhs)
{
}
HRESULT CBloodymurderer::Initialize_Prototype(void)
{
...
HRESULT CBloodymurderer::Initialize(void * pArg)
{
...
void CBloodymurderer::Tick(_float fTimeDelta)
{
...
void CBloodymurderer::Late_Tick(_float fTimeDelta)
{
...
HRESULT CBloodymurderer::Render(void)
{
	if (!m_bRespawn)
	{
...
HRESULT CBloodymurderer::SetUp_Components(void)
{
	...
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_IDLE_Front"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Bloodymurderer_IDLE_Front"), (CComponent**)&m_pTextureComIDLE_Front)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_IDLE_Back"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Bloodymurderer_IDLE_Back"), (CComponent**)&m_pTextureComIDLE_Back)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Move_Front"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Bloodymurderer_Move_Front"), (CComponent**)&m_pTextureComMove_Front)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Move_Back"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Bloodymurderer_Move_Back"), (CComponent**)&m_pTextureComMove_Back)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Attack_Front"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Bloodymurderer_Attack_Front"), (CComponent**)&m_pTextureComAttack_Front)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Attack_Back"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Bloodymurderer_Attack_Back"), (CComponent**)&m_pTextureComAttack_Back)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Dead_Front"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Bloodymurderer_Dead_Front"), (CComponent**)&m_pTextureComDead_Front)))
		return E_FAIL;
	if (FAILED(__super::Add_Components(TEXT("Com_Texture_Dead_Back"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Bloodymurderer_Dead_Back"), (CComponent**)&m_pTextureComDead_Back)))
		return E_FAIL;
...
HRESULT CBloodymurderer::SetUp_RenderState(void)
{
...
HRESULT CBloodymurderer::Release_RenderState(void)
{
...
void CBloodymurderer::Check_Hit()
{
	if (m_tInfo.bHit)
	{
		CGameInstance*			pGameInstance = CGameInstance::Get_Instance();
...
void CBloodymurderer::Chase(_float fTimeDelta)
{
...
void CBloodymurderer::Chase2(_float fTimeDelta)
{
...
void CBloodymurderer::Chase3(_float fTimeDelta)
{
	_float Distance = D3DXVec3Length(&(*(_float3*)&m_tInfo.pTarget->Get_World().m[3][0] - m_pTransformCom->Get_State(CTransform::STATE_POSITION)));
	if (1.f >= Distance)
	{
...
void CBloodymurderer::OnTerrain()
{
	CGameInstance*		pGameInstance = CGameInstance::Get_Instance();
	if (nullptr == pGameInstance)
		return;
...
CBloodymurderer * CBloodymurderer::Create(LPDIRECT3DDEVICE9 _pGraphic_Device)
{
	CBloodymurderer* pInstance = new CBloodymurderer(_pGraphic_Device);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		ERR_MSG(TEXT("Failed to Created : CBloodymurderer"));
		Safe_Release(pInstance);
	}
...
CGameObject * CBloodymurderer::Clone(void * pArg)
{
	CBloodymurderer* pInstance = new CBloodymurderer(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		ERR_MSG(TEXT("Failed to Cloned : CBloodymurderer"));
		Safe_Release(pInstance);
	}
...
_float4x4 CBloodymurderer::Get_World(void)
{
	return m_pTransformCom->Get_WorldMatrix();
}

void CBloodymurderer::Free(void)
{
	__super::Free();
...
HRESULT CBloodymurderer::On_SamplerState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
HRESULT CBloodymurderer::Off_SamplerState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
HRESULT CBloodymurderer::Skill_DefaultAttack(const _tchar * pLayerTag)
{
	CGameInstance*			pGameInstance = CGameInstance::Get_Instance();
	Safe_AddRef(pGameInstance);
	...
	if (FAILED(pGameInstance->Add_GameObject(TEXT("Prototype_GameObject_SwordSlice"), m_tInfo.iLevelIndex, pLayerTag, &tInfo)))
		return E_FAIL;
...
void CBloodymurderer::Motion_Change()
{
...
void CBloodymurderer::Move_Frame(_float fTimeDelta)
{
	switch (m_eCurState)
	{
	case IDLE:
...
void CBloodymurderer::Check_Front()
{
...
void CBloodymurderer::Use_Skill(_float fTimeDelta)
{
...
HRESULT CBloodymurderer::TextureRender()
{
	switch (m_eCurState)
	{
	case IDLE:
...
void CBloodymurderer::MonsterMove(_float fTimeDelta)
{
...
HRESULT CBloodymurderer::RespawnMonster()
{
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, m_tInfo.vPos);
	m_ePreState = STATE_END;
	m_eCurState = IDLE;
...
void CBloodymurderer::OnBillboard()
{
...
void CBloodymurderer::CheckColl()
{
	CGameInstance* pInstance = CGameInstance::Get_Instance();
	if (nullptr == pInstance)
		return;

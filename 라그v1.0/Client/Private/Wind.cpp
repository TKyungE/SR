...
void CWind::Late_Tick(_float fTimeDelta)
{
...
void CWind::Move_Frame(_float fTimeDelta)
{
	switch (m_eCurState)
	{
	case IDLE:
...
HRESULT CWind::Off_SamplerState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
HRESULT CWind::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CWind::SetUp_RenderState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
HRESULT CWind::Release_RenderState()
{
...
_float4x4 CWind::Get_World(void)
{

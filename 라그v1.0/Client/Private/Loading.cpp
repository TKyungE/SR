...
HRESULT CLoading::SetUp_Components()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::Add_Components(TEXT("Com_Texture"), LEVEL_LOADING, TEXT("Prototype_Component_Texture_Loading"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;
...
HRESULT CLoading::SetUp_RenderState()
{
...
HRESULT CLoading::Release_RenderState()
{
...
CLoading * CLoading::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	...
	{
		ERR_MSG(TEXT("Failed to Created : CLoading"));
...
CGameObject * CLoading::Clone(void* pArg)
{
	...
	{
		ERR_MSG(TEXT("Failed to Cloned : CLoading"));
		Safe_Release(pInstance);
	}
...
_float4x4 CLoading::Get_World(void)
{
	return _float4x4();
}

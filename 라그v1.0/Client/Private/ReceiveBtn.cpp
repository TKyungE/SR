...
HRESULT CReceiveBtn::Initialize_Prototype()
{
...
HRESULT CReceiveBtn::Initialize(void * pArg)
{
...
HRESULT CReceiveBtn::SetUp_Components()
{
	/* For.Com_Renderer */
...
CGameObject * CReceiveBtn::Clone(void * pArg)
{
	CReceiveBtn*	pInstance = new CReceiveBtn(*this);
...
_float4x4 CReceiveBtn::Get_World(void)
{
	return _float4x4();
}

void CReceiveBtn::Free()
{
	__super::Free();

...
class CTown_Quest1 final : public CGameObject
{
public:
...
private:
	CTown_Quest1(LPDIRECT3DDEVICE9 pGraphic_Device);
	CTown_Quest1(const CTown_Quest1& rhs);
	virtual ~CTown_Quest1() = default;
...
public:
	static CTown_Quest1* Create(LPDIRECT3DDEVICE9 _pGraphic_Device);

...
namespace Client
{
	...
	enum LEVEL { LEVEL_STATIC, LEVEL_LOADING, LEVEL_LOGO, LEVEL_GAMEPLAY, LEVEL_TOWN, LEVEL_CHOBOFIELD, LEVEL_MIDBOSS, LEVEL_TOWN2, LEVEL_DESERT1, LEVEL_MAZE, LEVEL_END };
	enum CHANNELID { SOUND_EFFECT, SOUND_BGM, MAXCHANNEL };
	enum MONSTERTYPE { MON_ALLIGATOR, MON_ELDERWILOW, MON_BIGFOOT, MON_BYORGUE, MON_BLOODYMURDERER, MON_DANDELION, MON_ATROS, MON_BAPHOMET, MON_MINOROUS, MON_SKELETON, MON_WRAITH, MON_ZOMBIE, MON_END };

...
namespace Client
{
	...
	enum LEVEL { LEVEL_STATIC, LEVEL_LOADING, LEVEL_LOGO, LEVEL_GAMEPLAY, LEVEL_TOWN, LEVEL_CHOBOFIELD, LEVEL_MIDBOSS, LEVEL_TOWN2, LEVEL_DESERT1, LEVEL_MAZE, LEVEL_SKY, LEVEL_FINALBOSS, LEVEL_END };

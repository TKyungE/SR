...
namespace Client
{
	...
	enum MONSTERTYPE { MON_ALLIGATOR, MON_ELDERWILOW, MON_BIGFOOT, MON_BYORGUE, MON_BLOODYMURDERER, MON_DANDELION, MON_ATROS, MON_BAPHOMET, MON_MINOROUS, MON_SKELETON, MON_WRAITH, MON_ZOMBIE, MON_TOTEM,MON_END };

...
class CThunderCloud final : public CGameObject
{
private:
	CThunderCloud(LPDIRECT3DDEVICE9 pGraphic_Device);
	CThunderCloud(const CThunderCloud& rhs);
	virtual ~CThunderCloud() = default;
public:

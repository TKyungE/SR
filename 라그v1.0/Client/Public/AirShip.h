...
class CAirShip final : public CGameObject
{
public:
...
private:
	CAirShip(LPDIRECT3DDEVICE9 _pGraphic_Device);
	CAirShip(const CAirShip& rhs);
...
private:
	...
	void	OnBillboard();
public:
	static CAirShip* Create(LPDIRECT3DDEVICE9 _pGraphic_Device);

...
class CMinorous final : public CGameObject
{
public:
	enum STATE { IDLE, DEAD, SKILL, MOVE, STATE_END };
private:
	CMinorous(LPDIRECT3DDEVICE9 _pGraphic_Device);
	CMinorous(const CMinorous& rhs);
	virtual ~CMinorous() = default;
...
public:
	static CMinorous* Create(LPDIRECT3DDEVICE9 _pGraphic_Device);

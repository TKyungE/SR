...
class CDandelion final : public CGameObject
{
public:
	enum STATE { IDLE, DEAD, SKILL, MOVE, STATE_END };
private:
	CDandelion(LPDIRECT3DDEVICE9 _pGraphic_Device);
	CDandelion(const CDandelion& rhs);
	virtual ~CDandelion() = default;
...
public:
	static CDandelion* Create(LPDIRECT3DDEVICE9 _pGraphic_Device);

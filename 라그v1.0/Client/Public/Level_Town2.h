...
class CLevel_Town2 final : public CLevel
{
private:
	CLevel_Town2(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_Town2() = default;
...
public:
	static CLevel_Town2* Create(LPDIRECT3DDEVICE9 pGraphic_Device);

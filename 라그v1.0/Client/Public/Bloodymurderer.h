...
class CBloodymurderer final : public CGameObject
{
public:
	enum STATE { IDLE, DEAD, SKILL, MOVE, STATE_END };
private:
	CBloodymurderer(LPDIRECT3DDEVICE9 _pGraphic_Device);
	CBloodymurderer(const CBloodymurderer& rhs);
	virtual ~CBloodymurderer() = default;
...
public:
	static CBloodymurderer* Create(LPDIRECT3DDEVICE9 _pGraphic_Device);

...
class CRichClone final : public CGameObject
{
public:
	enum STATE { IDLE, DEAD, SKILL, MOVE, STATE_END };
private:
	CRichClone(LPDIRECT3DDEVICE9 _pGraphic_Device);
	CRichClone(const CRichClone& rhs);
	virtual ~CRichClone() = default;
...
public:
	static CRichClone* Create(LPDIRECT3DDEVICE9 _pGraphic_Device);

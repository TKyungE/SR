...
class CBaphomet final : public CGameObject
{
public:
	enum STATE { IDLE, DEAD, SKILL, MOVE, STATE_END };
private:
	CBaphomet(LPDIRECT3DDEVICE9 _pGraphic_Device);
	CBaphomet(const CBaphomet& rhs);
	virtual ~CBaphomet() = default;
...
public:
	static CBaphomet* Create(LPDIRECT3DDEVICE9 _pGraphic_Device);

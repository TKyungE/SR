...
BEGIN(Client)
class CHouse5 final : public CGameObject
{
public:
...
private:
	CHouse5(LPDIRECT3DDEVICE9 _pGraphic_Device);
	CHouse5(const CHouse5& rhs);
	virtual ~CHouse5() = default;
public:
...
public:
	static CHouse5* Create(LPDIRECT3DDEVICE9 _pGraphic_Device);

...
class CAtros final : public CGameObject
{
public:
	enum STATE { IDLE, DEAD, SKILL, MOVE, STATE_END };
private:
	CAtros(LPDIRECT3DDEVICE9 _pGraphic_Device);
	CAtros(const CAtros& rhs);
	virtual ~CAtros() = default;
...
public:
	static CAtros* Create(LPDIRECT3DDEVICE9 _pGraphic_Device);

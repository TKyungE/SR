...
class CTown_Quest3 final : public CGameObject
{
public:
...
private:
	CTown_Quest3(LPDIRECT3DDEVICE9 pGraphic_Device);
	CTown_Quest3(const CTown_Quest3& rhs);
	virtual ~CTown_Quest3() = default;
...
public:
	static CTown_Quest3* Create(LPDIRECT3DDEVICE9 _pGraphic_Device);
